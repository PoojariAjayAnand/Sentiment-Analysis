...
#Loading of data
path = os.getcwd()+r'\Sentiment Analysis\data'
data=load_dataset(path+'\hotel-reviews.csv')

#Split data
x_train, x_test, y_train, y_test = train_test_split(data['Description'], data['Ratings'], test_size=0.01, random_state=42)
